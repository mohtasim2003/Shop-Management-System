...
public class Management extends JFrame implements ActionListener,MouseListener
{
    ...
    public Management(Shop s,Homepage h,Employee em)
    {
        ...
        ImageIcon img =new ImageIcon("Icon/himages.png");
        ...
        sms.setFont(new Font("Book Antiqua", 0, 32));
        leftPanel.add(sms);
        this.add(leftPanel);
        ...
        title.setFont(new Font("Book Antiqua", 0, 24));
        this.add(title);
        ...
        productMNG.setBackground(new Color(0,204,0));
        ...
        employeeMNG.setBackground(new Color(0,204,0));
        ...
        shopINFO.setBackground(new Color(0,204,0));
        shopINFO.setForeground(new Color(255,255,255));
        shopINFO.setFont(new Font("Book Antiqua", 0, 24));
        ...
        exitButton.setBackground(new Color(0,204,0));
    ...
    public void mouseEntered(MouseEvent me)
    {
         ...
         else if(me.getSource() == exitButton)
        {
            ...
            exitButton.setForeground(new Color(0,204,0));
        }
        else 
        {
