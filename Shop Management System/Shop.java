...
public class Shop extends JFrame implements ActionListener,MouseListener
{
    ...
    public Shop(Login l)
    {
        ...
        ImageIcon img =new ImageIcon("Icon/images (2).png");
        ...
        sms.setForeground(new Color(0,0,51));
        ...
        cShop = new JLabel("Creating a Shop");
        cShop.setBounds(502, 50, 300, 35);
        cShop.setForeground(new Color(0,0,51));
        cShop.setFont(new Font("Algerian", 0, 24));
        this.add(cShop);
        ...
        nextButton.setBackground(new Color(0,204,0));
    ...
    public void mouseEntered(MouseEvent me)
    {
        if(me.getSource() == nextButton)
        {
            ...
            nextButton.setForeground(new Color(0,204,0));
        }
